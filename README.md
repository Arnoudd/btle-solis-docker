...
MQTT_PORT: "1883" 
MQTT_USERNAME: "YOUR_MQTT_USERNAME" # Leave empty if not needed for your MQTT configuration
MQTT_PASSWORD: "YOUR_MQTT_PASSWORD" # Leave empty if not needed for your MQTT configuration
```
